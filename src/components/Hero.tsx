...
const Hero: React.FC = () => {
  return (
    <div className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl overflow-hidden p-4 sm:p-10 mb-4 sm:mb-6">
      <div className="absolute inset-0 bg-gradient-to-r from-blue-600/10 to-purple-600/10"></div>
      <div className="relative max-w-4xl mx-auto flex flex-col sm:flex-row items-center gap-4 sm:gap-12 text-center sm:text-left">
        <div className="flex-shrink-0">
          <a href="https://www.hidevs.xyz/" target="_blank" rel="noopener noreferrer">
            <img src={logo} alt="HiDevs Logo" className="h-16 sm:h-28 object-contain" />
          </a>
        </div>
