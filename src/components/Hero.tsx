  ...
  return (
    <div className="relative">
      ...
      <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 overflow-hidden pt-2 pb-10">
        ...
        <div className="relative max-w-4xl mx-auto px-0 sm:px-0 lg:px-0 flex flex-row items-center gap-32">
          {/* Left: Large Logo as Link */}
          <div className="flex-shrink-0 flex flex-col items-center justify-center">
            <a href="https://www.hidevs.xyz/" target="_blank" rel="noopener noreferrer">
              <img src={logo} alt="HiDevs Logo" className="h-32 w-32 object-contain" />
            </a>
          </div>
          {/* Right: Text Content */}
          <div className="flex-1 flex flex-col justify-center mt-0">
            <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 leading-tight max-w-4xl mb-4 whitespace-nowrap">
            ...
            <div className="text-lg text-gray-700 max-w-3xl font-normal mt-2">
